...
namespace MJsniffer
{
    public class TCPHeader
    {
        ...
        internal uint uiSequenceNumber = 555;          //Thirty two bits for the sequence number
        internal uint   uiAcknowledgementNumber=555;   //Thirty two bits for the acknowledgement number
        ...
        internal ushort sChecksum = 555;                 //Sixteen bits for the checksum
