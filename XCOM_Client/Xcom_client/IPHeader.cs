    ...
    public class IPHeader
    {
        ...
        public IPHeader(byte[] byBuffer, int nReceived)
        {
            ...
            try
            {
                ...
                //Better way of calculating checksum
                //sChecksum = CRC16.Compute(byBuffer, 0, nReceived);
        ...
        public string Version_con
        {
            get
            {
                return ((int)(byVersionAndHeaderLength >> 4)).ToString();
            }
        }
        ...
        public string DifferentiatedServices_con
        {
            get
            {
        ...
        public Xcom_client.Utils.Protocol ProtocolType
        {
            get
            {
                ...
                {
                    return Xcom_client.Utils.Protocol.TCP;
                }
                else if (byProtocol == 17)  //Seventeen for UDP
                {
                    return Xcom_client.Utils.Protocol.UDP;
                }
                else
                {
                    return Xcom_client.Utils.Protocol.Unknown;
                }
            }
        }
        ...
        public IPAddress SourceAddress
        {
            get
            {
                //IPAddress temp = new IPAddress(uiSourceIPAddress);
        ...
        public IPAddress DestinationAddress
        {
            get
            {
                //IPAddress temp = new IPAddress(uiDestinationIPAddress);
                //return temp;
